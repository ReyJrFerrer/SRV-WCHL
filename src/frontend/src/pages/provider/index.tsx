...
//             } else {
//               setError(
//                 "Access denied. A Service Provider profile is required.",
//               );
//             }
//           } else if (
...
//         setIsLoading(false);
//         setStatusMessage(
//           "Please log in or create an account to access the provider portal.",
//         );
//       }
//     };
...
//         <meta
//           name="description"
//           content="Access your provider portal or log in."
//         />
//       </Head>
//       <div className="flex min-h-screen items-center justify-center bg-gray-50 p-4">
//         <div className="mx-auto w-full max-w-md rounded-xl border-t-4 border-yellow-300 bg-white p-8 text-center shadow-2xl">
