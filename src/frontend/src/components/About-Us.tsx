        ...
        <div className="about-hero-content">
          ...
          <div className="about-hero-text">
            ...
            <p className="about-hero-description">
              Mobile Phone? Laptop? Computer? Any other devices? SRV (Serbisyo,
              Rito, Valid) is here for you anywhere, anytime. Designed to act as
              a centralized digital marketplace connecting clients seeking
              various services with independent, local freelance service
              providers in Baguio City. Built specifically for the Filipino
              community, SRV bridges the gap between reliable service needs and
              trusted local professionals, moving beyond the limitations of
              Facebook groups and word-of-mouth referrals.
            </p>
          ...
          <div className="gallery-container">
            ...
            <div className="gallery-image-wrapper" data-index="1">
              ...
              <div className="image-overlay">
                ...
                <p className="overlay-description">Mechanics, car detailing</p>
              </div>
            </div>
            ...
            <div className="gallery-image-wrapper" data-index="5">
              ...
              <div className="image-overlay">
                ...
                <p className="overlay-description">Shopping, document delivery</p>
              </div>
            </div>
            ...
            <div className="pillar-card">
              ...
              <div className="pillar-content">
                <p className="pillar-description">
                  Rooted in Baguio, we built SRV to rethink how communities and
                  service providers connect moving beyond inconsistent Facebook
                  groups and word-of-mouth searches, we created a platform where
      ...
      <div className="container">
        <div className="info-grid">
          ...
          <div className="info-card">
            ...
            <a href="contact.html" className="btn-secondary"> Get Support </a>
          </div>
        </div>
      </div>
    </section>
      ...
      <div className="container">
        <div className="team-header">
          ...
          <p className="team-description">
            The passionate individuals behind SRV, working to revolutionize how
            Filipino communities connect with local services.
          </p>
        </div>
